@php
    ...
    $editorType = $page->editor_type ?? 'tinymce';
@endphp
...
<x-admin::layouts>
    ...
    <v-edit-cms-page></v-edit-cms-page>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <input 
                        type="hidden" 
                        name="{{ $currentLocale->code }}[structured_content][html]" 
                        :value="options.html"
                    >

                    <input 
                        type="hidden" 
                        name="{{ $currentLocale->code }}[structured_content][css]" 
                        :value="options.css"
                    >
        ...
        <script type="text/x-template" id="v-edit-cms-page-template">
            <!--Create Page Form -->
            <x-admin::form
        ...
        <script type="module">
            app.component('v-edit-cms-page', {
                template: '#v-edit-cms-page-template',
            });
            ...
            app.component('v-static-content-cms', {
                ...
                data() {
                    return {
                        ...
                        options: @json($page->translate($currentLocale->code)['structured_content'] ?? null),
        ...
        <script type="module">
            ...
            app.component('v-html-editor-cms', {
                ...
                data() {
                    return {
                        options:{
                            html: `{!! $page->translate($currentLocale->code)['structured_content']['html'] ?? '' !!}`,
                        },
        ...
        <script type="module">
            ...
            app.component('v-css-editor-cms', {
                ...
                data() {
                    return {
                        options:{
                            css: `{!! $page->translate($currentLocale->code)['structured_content']['css'] ?? '' !!}`,
                        },
                    };
                },
