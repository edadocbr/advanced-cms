...
namespace Edado\AdvancedCMS\Http\Controllers;
...
class PageController extends Controller
{
    ...
    public function uploadImage()
    {
        ...
        try {
            ...
            $path = 'cms_structured/' . Str::random(40) . '.webp';
    ...
    public function index()
    {
        ...
        return view('advanced_cms::admin.cms.index');
    }
    ...
    {
        return view('advanced_cms::admin.cms.create');
    }
    ...
    public function store()
    {
        $this->validate(request(), [
            ...
            'page_title'   => 'required',
            'html_content' => 'required_if:editor_type,tinymce',
            'channels'     => 'required|array|min:1',
            'editor_type'  => 'required|in:tinymce,structured',
        ]);
    ...
    public function edit(int $id)
    {
        ...
        return view('advanced_cms::admin.cms.edit', compact('page'));
    }
    ...
    public function update(int $id)
    {
        ...
        $this->validate(request(), [
            ...
            $locale.'.html_content'   => $editorType == 'tinymce' ? 'required' : 'nullable',
            'channels'                => 'required|array|min:1',
        ]);
